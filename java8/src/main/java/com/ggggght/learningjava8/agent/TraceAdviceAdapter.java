...
//
//
// protected TraceAdviceAdapter(String className, MethodVisitor methodVisitor, int
// methodAccess, String methodName, String methodDesc) {
...
// mv.visitMethodInsn(INVOKESTATIC, "java/time/LocalDateTime", "now",
...
// "com/ggggght/learningjava8/agent/TraceAdviceAdapter", "sayHello", "()V", false);
// }
//
// @Override
...
// "(Ljava/lang/String;)V", false);
// // mv.visitMethodInsn(INVOKESTATIC,
// "com/ggggght/learningjava8/agent/TraceAdviceAdapter", "sayBye", "()V", false);
// }
//
