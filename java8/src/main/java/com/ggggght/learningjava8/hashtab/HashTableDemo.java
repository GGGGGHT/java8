...
public class HashTableDemo {
	...
	public static void main(String[] args) {
		/*
		 * HashTable table = new HashTable(7); table.put(new User(1,"zs")); table.put(new
		 * User(2,"ls")); table.put(new User(3,"ww")); table.put(new User(4,"zl"));
		 * table.put(new User(5,"hh")); table.put(new User(6,"zz")); table.put(new
		 * User(7,"ss")); table.put(new User(8,"tt")); table.list(); Optional<User> user =
		 * table.get(4); System.out.println(user.orElseGet(() -> new User(10, "tt")));
		 */
...
class User {
	...
	public String toString() {
		return "User{" + "id=" + id + ", name='" + name + '\'' + ", next=" + next + '}';
	}
